...
public void dropListChoixBrowser_click(GDropList source, GEvent event) { //_CODE_:dropListChoixBrowser:721568:
...
synchronized public void win_draw1(PApplet appc, GWinData data) { //_CODE_:openingWindows:473159:
  appc.background(230);
...
public void dropList1_click1(GDropList source, GEvent event) { //_CODE_:dropList1:468108:
  println("dropList1 - GDropList >> GEvent." + event + " @ " + millis());
} //_CODE_:dropList1:468108:
...
public void createGUI(){
  ...
  addColl = new GCheckbox(this, 3, 70, 260, 20);
  addColl.setIconAlign(GAlign.LEFT, GAlign.MIDDLE);
  addColl.setText("Modifier les collisions Ajouter / Supprimer");
  addColl.setOpaque(false);
  addColl.addEventHandler(this, "addColl_clicked1");
  collision_panel.addControl(showCollisionCheckbox);
  collision_panel.addControl(objectCollision);
  collision_panel.addControl(addColl);
  ...
  dropList1 = new GDropList(openingWindows, 155, 155, 196, 88, 3, 10);
  dropList1.setItems(loadStrings("list_468108"), 0);
...
GPanel down_panel; 
GView browser; 
GDropList dropListChoixBrowser; 
GPanel panel7; 
GLabel label1; 
GLabel wordpos; 
GLabel zoomView; 
